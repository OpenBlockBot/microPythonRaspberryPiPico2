...
const DIVECE_OPT = {
    ...
    firmware: 'microPython-standard-raspberryPiPico2.uf2'
};
...
class MicroPythonRaspberryPiPico2 extends CommonPeripheral {
    constructor (runtime, deviceId) {
        super(runtime, deviceId, PNPID_LIST, SERIAL_CONFIG, DIVECE_OPT);
    }
}

class OpenBlockMicroPythonRaspberryPiPico2Device {
    get DEVICE_ID () {
        return 'microPythonRaspberryPiPico2';
    }
    ...
    get MODE_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2.modeMenu.input',
                    default: 'input',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2.modeMenu.output',
                    default: 'output',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2.modeMenu.inputPullup',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2.modeMenu.inputPulldown',
    ...
    get LEVEL_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2.levelMenu.high',
                    default: 'high',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2.levelMenu.low',
                    default: 'low',
    ...
    get INTERRUP_MODE_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2.InterrupModeMenu.risingEdge',
                    default: 'rising edge',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2.InterrupModeMenu.fallingEdge',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2.InterrupModeMenu.changeEdge',
                    default: 'change edge',
    ...
    get EOL_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2.eolMenu.warp',
                    default: 'warp',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2.eolMenu.noWarp',
                    default: 'no-warp',
    ...
    constructor (runtime) {
        ...
        this._peripheral = new MicroPythonRaspberryPiPico2(this.runtime, this.DEVICE_ID);
    }
        ...
        return [
            {
                id: 'pin',
                name: formatMessage({
                    id: 'microPythonRaspberryPiPico2.category.pins',
                    default: 'Pins',
                ...
                blocks: [
                    {
                        opcode: 'setPinMode',
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2.pins.setPinMode',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2.pins.setDigitalOutput',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2.pins.setPwmOutputU16',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2.pins.readDigitalPin',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2.pins.readAnalogPin',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2.pins.setServoOutputU16',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2.pins.attachInterrupt',
            ...
            },
            {
                id: 'serial',
                name: formatMessage({
                    id: 'microPythonRaspberryPiPico2.category.serial',
                    default: 'Serial',
                ...
                blocks: [
                    {
                        opcode: 'raspberryPiPico2SerialBegin',
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2.serial.raspberryPiPicoSerialBegin',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2.serial.multiSerialPrint',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2.serial.multiSerialReadALine',
            ...
            },
            {
                id: 'console',
                name: formatMessage({
                    id: 'microPythonRaspberryPiPico2.category.console',
                    default: 'Console',
                ...
                blocks: [
                    {
                        opcode: 'consolePrint',
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2.console.consolePrint',
                    ...
                    },
                    {
                        opcode: 'consoleInput',
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2.console.consoleInput',
...
export default OpenBlockMicroPythonRaspberryPiPico2Device;
